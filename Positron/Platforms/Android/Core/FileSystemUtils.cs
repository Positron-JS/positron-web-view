...
static partial class FileSystemUtils
{
    ...
    public static async Task<string> EnsurePhysicalPath(AndroidUri uri, bool requireExtendedAccess = true)
    {
...
#pragma warning restore CS0618
    ...
    static async Task<string> CacheContentFileAsync(AndroidUri uri)
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    internal static AndroidUri GetShareableFileUri(FileBase file)
    {
        ...
        if (IsFileInPublicLocation(file.FullPath))
        {
        ...
        else
        {
            ...
            var tmpFile = GetTemporaryFile(root, file.FileName);
        ...
        {
            return GetUriForFile(sharedFile);
        }
